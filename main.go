...
func main() {
	...
	flag.StringVar(&cmd.FieldCreatedAt, "add", "created_at,add_at", "automatically set timestamp on insert, database type: INTEGER NOT NULL DEFAULT 0") // created at
	flag.StringVar(&cmd.FieldUpdatedAt, "mod", "updated_at,mod_at", "automatically set timestamp on update, database type: INTEGER NOT NULL DEFAULT 0") // updated at
	flag.StringVar(&cmd.FieldDeletedAt, "del", "deleted_at,del_at", "delete timestamp, database type: INTEGER NOT NULL DEFAULT 0")                      // deleted at

...
func init() {
	...
	flag.BoolVar(&param.BizCommon, "bc", false, "whether to create common.go of biz module, call with databases faster")                                                       // whether to create common.go of biz module, call with databases faster
	flag.StringVar(&param.BizCommonContent, "bcc", "table1.field1,table2.field2,table3.field3", "create single field methods for insert, update, and delete in biz/common.go") // create single field methods for insert, update, and delete in biz/common.go

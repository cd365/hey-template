...
func init() {
	...
	flag.StringVar(&param.TableFieldMethodOfData, "dtf", "table1.field1,table2.field2,table3.field3", "single field custom methods, in data") // single field custom methods, in data

...
func Mysql(app *App) Helper {
	return &mysql1{app: app}
}
...
func (s *mysql1) getAllColumns(schema string, table *SysTable) (list []*SysColumn, err error) {
...
func (s *mysql1) AllTable() []*SysTable {
	return s.tables
}

func (s *mysql1) TableDdl(table *SysTable) error {
